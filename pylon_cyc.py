...
def test_periodic_send_with_modifying_data(bus, dbc_path):
    ...
    Bat_i = -10
    Bat_U = 52
    logger.info("Starting to send a message every 1s")
...
#        return
    while True:
      ...
      logger.info("updating data ", Alive_packet )
...
if __name__ == "__main__":
    ...
    for interface, channel in [
        ...
        logger.info("Carrying out cyclic tests with {} interface".format(interface))
